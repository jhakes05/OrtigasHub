...
const Landing = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-row justify-around pt-[4rem] relative">
        <a href="/card1" className="flex-none p-2 relative">
          <img src={card1} alt="Card 1" className="w-64 h-64 rounded-lg shadow-lg" />
          <div className="absolute inset-0 flex justify-center items-center text-white text-lg font-bold shadow-lg">
